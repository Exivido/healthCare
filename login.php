...
if(isset($_POST['login']))
{
    ...
    if(mysqli_num_rows($result)==1)
    {
        ...
        setcookie("usertype","user",30*24*60*60*1000);
...
}else if(isset($_POST['register']))
{
    ...
    {
        $sql = "INSERT INTO users (name,username,password,picture) VALUES ('$name','$username','$password','$imageData')";
    ...
    <div class="flip-card">
        <div class="inner-card">
            <div class="login">
                ...
                <a href="doc-login.php" class="creat-account" > ایا پزشک هستید؟</a>

                <a href="#" class="creat-account" onclick="flip()"> ثبت نام</a>

            </div>
            <div class="sign-up">
                <form action="login.php" method="post" enctype="multipart/form-data" id="sign-up-form">
                    <div class="un-container">
